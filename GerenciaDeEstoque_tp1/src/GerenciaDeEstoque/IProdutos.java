...
public interface IProdutos {
     ...
     */
    boolean removeProduto(int codigo);
     ...
     */
    boolean updateQuantidade(int codigo, double nova);
     ...
     */
    boolean updatePreco(int codigo, double novo);
     ...
     */
    boolean addQuantidade(int codigo, double quantidade);
     ...
     */
    boolean subQuantidade(int codigo, double quantidade);
